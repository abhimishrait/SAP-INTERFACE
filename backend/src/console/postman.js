...
const SAMPLES = {
  ...
  'greater-circles':    { name: 'Zone A', code: 'ZONE_A', status: 'Y' },
  'circles':            { name: 'Town X', code: 'TOWN_X', greater_circle_name: 'Zone A', status: 'Y' },
  'container':          { name: 'CRATE', code: 'CRATE', level: 'PRIMARY', status: 'Y' },
  'matrix':             { name: 'Matrix Group 1', code: 'MATRIX_1', status: 'Y' },
  'product-class':      { name: 'Dairy Products', code: 'DAIRY', unit: 'Ltr', status: 'Y' },
  'product-name':       { name: 'Fresh Milk', product_class_name: 'Dairy Products', status: 'Y' },
  'payment-terms':      { payment_term_name: 'Net 30', code: 'NET_30', status: 'Y' },
  'price-list-group':   { name: 'Standard', code: 'STANDARD', status: 'Y' },
